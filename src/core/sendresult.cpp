...
SendResultPrivate::SendResultPrivate(qint64 bytesSent, quint32 messageId, quint64 sessionId, int messageType,
                                     const QString& error)
...
SendResult::SendResult(qint64 bytesSent, quint32 messageId, quint64 sessionId, int messageType, const QString& error)
...
quint64 SendResult::sessionId() const
{
...
void SendResult::setSessionId(quint64 sessionId)
{
