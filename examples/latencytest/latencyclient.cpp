...
int main(int argc, char* argv[])
{
    ...
    QObject::connect(processor.data(), &ExampleMessageProcessor::connAckReceived, [&client](quint64 sessionId) {
    ...
    processor->setLatencyTestCallback(
        [&latencyAnalyzer](const example::LatencyTestMessage& message, quint64, quint32) {
